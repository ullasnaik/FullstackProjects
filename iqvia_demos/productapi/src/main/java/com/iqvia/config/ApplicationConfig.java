...
public class ApplicationConfig {
	...
	@Bean
	public LocalSessionFactoryBean sessionFactory(DataSource datasource) throws IOException { //Spring ORM
		...
		properties.setProperty("hibernate.hbm2ddl.auto", "update"); //create, update, validate, none
