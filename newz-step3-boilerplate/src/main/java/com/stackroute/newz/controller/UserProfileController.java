...
public class UserProfileController {
	...
	@PostMapping("/user")
	public ResponseEntity addUserProfile(@RequestBody UserProfile userProfile) throws UserProfileAlreadyExistsException {
	...
	public ResponseEntity updateAllNews(@RequestBody UserProfile userProfile,@PathVariable String userId) throws UserProfileNotExistsException{
		return new ResponseEntity<>(userProfileService.updateUserProfile(userProfile,userId), HttpStatus.OK);
	}
	...
	public ResponseEntity getNews(@PathVariable String userId) throws UserProfileNotExistsException {
	...
	public ResponseEntity deleteNews(@PathVariable String userId) throws UserProfileNotExistsException{
