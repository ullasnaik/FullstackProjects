...
public class ReminderController {
	...
	@GetMapping
	public ResponseEntity<?> listReminders() {
	...
	public ResponseEntity<?> getReminderByReminderId(@PathVariable int reminderId) {
    ...
    public ResponseEntity<?> deleteNews(@PathVariable int reminderId) {
	 try {
